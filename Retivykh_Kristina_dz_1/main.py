...
def task_two():
    ...
    print("Сумма чисел из списка, сумма цифр которых делится нацело на 7: ", result_variant_a)
    print("Сумма чисел из списка, сумма цифр которых делится нацело на 7, после добавления числа 17  к каждому "
          "элементу списка: ", result_variant_b)
